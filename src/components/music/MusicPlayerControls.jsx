                                ...
                                {gameFinished === true ? null :
                                    ...
                                    (
                                        <div className="flex justify-center items-center text-custom-fg h-14 w-14 border-2 rounded-full relative overflow-hidden">
                                            ...
                                            type="button" 
                                            aria-label={i18n.t("main.stop")}
                                            title={i18n.t("main.stop")}
                                    ...
                                    (
                                        <div className="flex justify-center items-center text-custom-fg h-14 w-14 border-2 rounded-full relative overflow-hidden">
                                            ...
                                            className="player-button" 
                                            type="button" 
                                            aria-label={i18n.t("main.play")}
                                            title={i18n.t("main.play")}
