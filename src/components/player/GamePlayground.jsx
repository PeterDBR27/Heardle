    ...
    return (
        <div className="w-full flex flex-col flex-grow relative">
            <div className="max-w-screen-sm w-full mx-auto h-full flex flex-col justify-between overflow-auto">
                <div className="p-3 flex-col items-evenly">
                    {guessList.map((guess, index) => {
                        ...
                        if (guess.isSkipped === true) {
                            result = (
                                <>
                                    <div className="mr-2">{SKIP_ICON}</div>
                                    <div className="flex flex-1 justify-between items-center">
                                        <div className="text-sm tracking-widest font-bold text-gray">{i18n.t("main.skipped")}</div>
                                    </div>
                                </>
                            );
                            ...
                            result = (
                                <>
                                    <div className="mr-2">{WRONG_ICON}</div>
                                    <div className="flex flex-1 justify-between items-center">
                                        <div className="thinFont font-semibold text-gray">{guess.answer}</div>
                                    </div>
                                </>
                            );
                        }
                ...
                <div className="thinFont p-2 mb-2 flex flex-col items-center">
                        <div className="text-center">
                            <p className="text-gray">{i18n.t("main.volume")}</p>
                        </div>
                        <svg className="mt-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="gray" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
